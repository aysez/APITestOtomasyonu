...
public class C05_JsonObjesiOlusturma {
    ...
    public void test01(){
        ...
        // icerideki json objesini once olusturmakta fayda var
        ...
        requestBody.put("bookingdates",dateJsonObject); //daha onceden olusturdugumuz inner objecti burayaa koyduk
